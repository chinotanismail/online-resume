...
<footer class="sticky-footer bg-white">
  <div class="container my-auto">
    <div class="copyright text-center my-auto">
      <span>Copyright &copy; Chino Tan Ismail 2020</span>
    </div>
  </div>
</footer>
<!-- End of Footer -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="<?php echo admin_url();?>logout">Logout</a>
      </div>
    </div>
  </div>
</div>
...
<script src="<?php echo admin_asset_url();?>js/sb-admin-2.min.js"></script>
